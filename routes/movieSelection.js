...
router.get('/', async (req, res) => {
    ...
    if(!sesh.chosen && !sesh.active) {
        // applies to users who join session after the leader sets currentSession.active = true
        if(group.currentSession.sessionMembers.includes("1") && group.currentSession.active) {
    ...
    //groups.updateWatchList(sesh.groupID, watchList, sesh.user._id)
        ...
        movie_info = group.currentSession.chosen
        /*res.render('movieSelection/home', 
        { 
